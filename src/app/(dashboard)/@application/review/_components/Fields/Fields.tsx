  ...
  return (
    <div className="space-y-4">
      <Group name="About You" href="/about">
        <Row label="Given name" value={data.me.givenName} />
        <Row label="Family name" value={data.me.familyName} />
        <Row label="Gender" value={data.draftApplication?.gender} render={(value) => GENDER_NAMES[value]} />
        <Row
          label="Race / Ethnicity"
          value={data.draftApplication?.raceEthnicity}
          render={(value) => RACE_ETHNICITY_NAMES[value]}
        />
        <Row label="Birthday" value={data.draftApplication?.dateOfBirth} render={(value) => <Date value={value} />} />
      </Group>
      <Group name="Education" href="/education">
        <Row label="Graduation year" value={data.draftApplication?.graduationYear} />
        <Row
      ...
      <Group name="Shipping" href="/shipping">
        <Row label="Address line 1" value={data.draftApplication?.addressLine1} />
        ...
        <Row label="Postal code" value={data.draftApplication?.postalCode} />
        <Row label="Country" value={data.draftApplication?.country} />
      </Group>
    </div>
  );
};
